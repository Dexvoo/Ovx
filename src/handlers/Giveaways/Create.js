...
module.exports = async function GiveawayCreate(interaction) {
  ...
  if (!durationMs || durationMs < 60000) {
    ...
    return client.utils.Embed(
      ...
      Colors.Red,
      'Invalid Duration',
      'Please provide a valid duration (e.g., `10m`, `1h`, `2d`). Minimum is 1 minute.'
    );
  }
  ...
  if (requiredRole) {
    embed.addFields({
      name: 'Requirement',
      value: `You must have the ${requiredRole} role to enter.`,
    });
  }
  ...
  return client.utils.Embed(
    ...
    Colors.Green,
    'Giveaway Created!',
    `The giveaway for **${prize}** has been started in ${channel}.`
  );
};
