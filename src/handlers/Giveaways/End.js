...
module.exports = async function GiveawayEnd(interaction) {
    ...
    if (!giveawayDoc.isActive) {
        return client.utils.Embed(interaction, Colors.Orange, 'Already Ended', 'This giveaway has already ended.');
    }

    await endGiveaway(giveawayDoc, client);
    return client.utils.Embed(interaction, Colors.Green, 'Success', 'The giveaway has been ended successfully.');
};