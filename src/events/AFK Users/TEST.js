// const { Events, EmbedBuilder, Message, PermissionFlagsBits, GuildAuditLogsEntry, Guild, ApplicationCommandType, AuditLogEvent, PermissionsBitField } = require('discord.js');
...
//         } else if (!oldPerms.has(perm) && newPerms.has(perm)) {
