  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName('emoji1').setDescription('The first emoji to add.').setRequired(true)
        )
        .addStringOption((option) =>
          option.setName('emoji2').setDescription('The second emoji to add.').setRequired(false)
        )
        .addStringOption((option) =>
          option.setName('emoji3').setDescription('The third emoji to add.').setRequired(false)
        )
        .addStringOption((option) =>
          option.setName('emoji4').setDescription('The fourth emoji to add.').setRequired(false)
        )
        .addStringOption((option) =>
          option.setName('emoji5').setDescription('The fifth emoji to add.').setRequired(false)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName('emoji')
            .setDescription('The server emoji you want to edit.')
            .setRequired(true)
        )
        .addStringOption((option) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName('emoji').setDescription('The emoji to delete.').setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand.setName('list').setDescription('List all emojis in this server.')
    ),
