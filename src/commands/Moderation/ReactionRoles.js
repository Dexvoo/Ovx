...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName('emoji').setDescription('Set the emoji for the role.').setRequired(true)
        )
        .addStringOption((option) =>
          option
            .setName('messageid')
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName('view').setDescription('View reaction roles for your server.')
    ),
  /**
  ...
  async execute(interaction) {
    ...
    if (!handlers[`ovx-reactionroles-${subcommand}`])
      return interaction.client.utils.Embed(
        interaction,
        Colors.Red,
        'Reaction Roles | Not Found',
