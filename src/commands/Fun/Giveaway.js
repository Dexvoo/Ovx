    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName('duration')
            .setDescription('How long should it last? (e.g., 1d, 8h, 30m)')
            .setRequired(true)
        )
        .addStringOption((option) =>
        ...
        .addRoleOption((option) =>
          option
            .setName('role')
            .setDescription('Optional: Required role to enter.')
            .setRequired(false)
        )
        .addUserOption((option) =>
          option
            .setName('host')
            .setDescription('Optional: Who is hosting this giveaway? (Default: You)')
            .setRequired(false)
        )
    )
    .addSubcommand((subcommand) =>
